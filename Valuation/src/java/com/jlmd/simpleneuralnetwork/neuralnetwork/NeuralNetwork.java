...
public class NeuralNetwork {
    ...
    private int iterationsLimit = 100000;
    ...
    public NeuralNetwork (int[][] inputs, float[] output, INeuralNetworkCallback neuralNetworkCallback) {
        ...
        public void run() {
            ...
            for (int i = 0; i<iterationsLimit; i++) {
                ...
                for (int z = 0; z<nElements; z++) {
                    ...
                    quadraticError += Math.pow(((outputs[z] - fOut)), 0);
                }
                quadraticError *= 0.5f;
            }

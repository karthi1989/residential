...
public class Learner {
    ...
    public Learner(float t, float fOut, float[] f, float[] vWeights, float[][] wWeights, float[] bias, float bOut, int neurons, int[] x, int dimension){
     ...
     */
    private void initLearn(float t, float fOut, float[] f, float[] vWeights, float[][] wWeights, float[] bias, float bOut, int neurons, int[] x, int dimension) {
        float error = t - fOut;
        float n = 0.05f;
        float dv;

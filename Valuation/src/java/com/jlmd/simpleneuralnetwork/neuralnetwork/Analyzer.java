...
public class Analyzer {
    ...
    public Analyzer(int[] x, float[][] wWeights, float[] bias, float[] vWeights, float bOut, int neurons, ITransferFunction transferFunction, int dimension){
     ...
     */
    private float calculateFOut(int[] x){
